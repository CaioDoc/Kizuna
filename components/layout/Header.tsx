    ...
    <header className="sticky top-0 z-40 w-full glass-panel border-b border-[#1f1f2e] px-3 sm:px-6 lg:px-8 py-2.5 transition-all">
      <div className="flex items-center justify-between gap-2 sm:gap-4 max-w-7xl mx-auto">
        ...
        <div className="flex items-center gap-2.5 shrink-0">
          <div className="relative flex items-center justify-center w-9 h-9 sm:w-10 sm:h-10 rounded-xl bg-gradient-to-tr from-[#8b5cf6] to-[#06b6d4] p-[2px] glow-purple shrink-0">
        ...
        <div className="flex items-center gap-1.5 sm:gap-3 shrink-0">
          ...
          <button
            ...
            className="flex items-center gap-1 bg-[#8b5cf6]/15 hover:bg-[#8b5cf6]/30 border border-[#8b5cf6]/40 px-2 sm:px-3 py-1 sm:py-1.5 rounded-xl text-xs font-bold text-[#a78bfa] transition-all"
            title="Scan QR Code to access on Mobile Smartphone"
          >
            <QrCode className="w-3.5 h-3.5 sm:w-4 sm:h-4 text-[#8b5cf6]" />
          ...
          {/* User Avatar */}
          <div className="flex items-center gap-2 pl-1 sm:pl-2 border-l border-[#1f1f2e]">
            <div className="relative group cursor-pointer">
              <Image
                ...
                width={36}
                height={36}
                className="w-8 h-8 sm:w-10 sm:h-10 rounded-xl object-cover border-2 border-[#8b5cf6] group-hover:border-[#06b6d4] transition-colors glow-purple"
                unoptimized
              />
